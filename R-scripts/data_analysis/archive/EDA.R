...
#load in data 
load("individual_project/alleles_capt_ideal_onepop.Rdata")
...
#Adding a new column for the number of seeds sampled per tree as well: 
tidy_df$seeds_per_tree = c(as.numeric(tidy_df$total_seeds) / as.numeric(tidy_df$maternal_trees))

#saving dataframe 
save(tidy_df, file = "individual_project/tidy_df.Rdata")
