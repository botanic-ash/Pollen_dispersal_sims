...
save(subset_data_new, transformed_model, file = "transformed_model.Rdata")
...
#Plotting the data
ggplot(data=preds) +
    geom_point(data = subset_data_new, aes(x=as.numeric(total_seeds), y=as.numeric(prop_capt), color=donor_type), alpha=0.25) +
